 ...
 * <p>
 * The circuitbreaker needs a SqlSessionFactory to create SqlSessions, passed as a constructor argument.
 ...
 * <p>
 * This circuitbreaker converts MyBatis PersistenceExceptions into unchecked DataAccessExceptions, using,
...
public class RWSqlSessionTemplate implements SqlSession {
     ...
     */
    public RWSqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType, PersistenceExceptionTranslator exceptionTranslator) {
